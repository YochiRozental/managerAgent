...
**הבא:** (1) תזמון יומי לסריקה (7:00) + הסלמה אגרסיבית (תזכורת לעובד → מנהל פרויקט → מוטי) + תדריך בוקר ב-WhatsApp למוטי. (2) נגישות חיצונית — שרת ענן. (3) הרחבת הצ'אט — "מה הבא?" אחרי סיום שלב. **אופטימיזציה:** לצמצם את `getReverseDependencyMap`.
